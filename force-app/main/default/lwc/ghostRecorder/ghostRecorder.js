...
import createTicket from '@salesforce/apex/GhostController.createQuickRequest'; // Points to the same method, just aliased clearly
import logActivity from '@salesforce/apex/GhostController.logUserActivity';
